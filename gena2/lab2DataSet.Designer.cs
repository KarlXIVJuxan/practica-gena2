...
namespace gena2.lab2DataSetTableAdapters {
    ...
    public partial class ColorTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::gena2.Properties.Settings.Default.lab2ConnectionString;
        }
...
SELECT id, Name_Human, ColorId FROM Human WHERE (id = @id)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, false)]
        public virtual int InsertQuery(string Name_Human) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            if ((Name_Human == null)) {
                command.Parameters[0].Value = global::System.DBNull.Value;
            }
